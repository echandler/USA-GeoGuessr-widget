...
runAsClient(() => {
    ...
    <defs xmlns="http://www.w3.org/2000/svg">
      <style type="text/css">
        ...
        .stateOnload {
            ...
            animation: stateOpacityOnload 1s ease-in, stateStrokeOnload 4s ease-in;
            animation-delay: 3s;
    ...
    paths.forEach((path) => {
        ...
        //  path.classList.add("stateFillOnload");
    ...
    function _localStorage(action, state) {
